...
def import_schedule_excel(
    ...
    try:
        # ========================================================
        # SPRINT07_PHASE4_REPLACE_SCHEDULE
        #
        # Excel Schedule Upload Contract:
        #
        #   Validate Excel
        #       |
        #   Replace Project Schedule
        #       |
        #   Import exactly Excel activities
        #       |
        #   Commit atomically
        #
        # The entire operation remains transactional.
        # Any validation/import exception must rollback the delete.
        # ========================================================
        ...
        # ========================================================
        # SPRINT07_ATOMIC_REPLACE
        #
        # Existing project schedule is deleted ONLY after:
        #   1. Excel has been successfully read
        #   2. Required columns have been validated
        #
        # The entire function is protected by rollback().
        # ========================================================
